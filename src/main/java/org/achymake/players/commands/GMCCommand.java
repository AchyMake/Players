                ...
                if (player.hasPermission("players.command.gamemode.others")) {
                    ...
                    if (target == player) {
                        if (!target.getGameMode().equals(GameMode.CREATIVE)) {
                            ...
                            Players.send(player, "&6You changed&f " + target.getName() + "&6 gamemode to&f Creative");
                        }
                    } else {
                        if (target != null) {
            ...
            if (args.length == 1) {
                ...
                if (target != null) {
                    if (!target.getGameMode().equals(GameMode.CREATIVE)) {
                        ...
                        Players.send(consoleCommandSender, "You changed " + target.getName() + " gamemode to Creative");
                    }
                }
            }
        }
